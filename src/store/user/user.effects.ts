...
export class UserEffects {
  ...
  public changeProfileDescription$ = createEffect(() =>
    this.actions$.pipe(
  ...
  public changeProfileAvatar$ = createEffect(() =>
    this.actions$.pipe(
      ofType(changeProfileAvatar),
      switchMap(({ newAvatar }) =>
        this.userService.changeUserAvatar(newAvatar).pipe(
  ...
  public deleteProfileAvatar$ = createEffect(() =>
    this.actions$.pipe(
      ofType(deleteProfileAvatar),
      switchMap(() =>
        this.userService.deleteUserAvatar().pipe(
  ...
  removeLoading$ = createEffect(() =>
    this.actions$.pipe(
      ofType(getMeSuccess, getMeFailure),
  ...
  removeUserAvatarLoading$ = createEffect(() =>
    this.actions$.pipe(
      ofType(changeProfileAvatarSuccess, changeProfileAvatarFailure),
